...
<html lang="en">
	<head>
	    ...
	    <title>Ferreteria DAO Online</title>
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(assets/images/sliders/banner_1.jpg);">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
	    
	    <div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/banner_2.jpg);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">envío gratis en pedidos superiores a $ 600.00</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">Todos los artículos en oferta, con descuentos de hasta un 20% </h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">PRODUCTOS DESTACADOS</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#Herr_mano" data-toggle="tab">Herramientas de mano</a></li>
					<li><a href="#Elem_union" data-toggle="tab">Elementos de unión</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
...
?>
	...
	<div class="tab-pane" id="Herr_mano">
					<div class="product-slider">
...
?>
	...
	<?php } ?>
		...
		<div class="tab-pane" id="Elem_union">
					<div class="product-slider">
						<div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
		<?php
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">Pernos</h3>
...
<?php }?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		<h3 class="section-title">Otras Herramientas</h3>
