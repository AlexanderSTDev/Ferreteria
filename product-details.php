...
?>
			...
			<ul class="list-inline list-unstyled">
				...
				<li style="width: 145px;"><?php echo htmlentities($rw['catname']);?></a></li>
...
?>
					...
					<div class="products">
						<div class="hot-deal-wrapper">
							<div class="image">
							<a href="product-details.php?pid=<?php echo htmlentities($rws['id']);?>"><img src="admin/productimages/<?php echo htmlentities($rws['id']);?>/<?php echo htmlentities($rws['productImage1']);?>"  width="200" height="334" alt=""></a>
							</div>
...
<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label">Producto marca:</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
							...
							<div class="product-social-link m-t-20 text-right">
								...
								<div class="social-icons">
						            <ul class="list-inline">
						                <li><a class="fa fa-facebook" href="http://www.facebook.com/sharer.php?u=www.sistemadao.com&t=Ferretería Online busca las herramientas que deseas aquí en Ferretería DAO" target="_blank"></a></li>
						                <li><a class="fa fa-twitter" href="https://twitter.com/intent/tweet?text=Ferretería_DAO&url=www.ferreteriadao.com&via=FerreteríaDAO&hashtags=#ferreteríadao_productosymas" target="_blank"></a></li>
						                <li><a class="fa fa-linkedin" href="http://www.linkedin.com/shareArticle?url=www.ferreteriadao.com" target="_blank"></a></li>
						                <li><a class="fa fa-rss" href="#" target="_blank"></a></li>
						                <li><a class="fa fa-pinterest" href="https://www.pinterest.com/pin/create/button/?url=www.ferreteriadao.com&description=Descripción+del+producto&media=https://img.interempresas.net/FotosArtProductos/P207706.jpg" target="_blank"></a></li>
						            </ul><!-- /.social-icons -->
						        </div>
							</div>
