		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-total">Total General</th>
				...
				<tr>
					...
					<td class="cart-image">
						<a class="entry-thumbnail" href="product-details.html">
						    <img src="admin/productimages/<?php echo $row['c'];?>/<?php echo $row['pimg1'];?>" alt="" width="130" height="150">
						</a>
					</td>
...
<tr>
	<td colspan="9"><div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary"><a href="payment-method.php">PROCESAR EL PAGO</a></button>
