...
if(isset($_POST['change']))
{
   $email=$_POST['email'];
	...
	if (strlen($password) < 8) {
        $_SESSION['errmsg'] = "La contraseña debe tener al menos 8 caracteres";
        header("location:forgot-password.php"); // Asegúrate de redirigir al formulario correcto
        exit();
...
<html lang="en">
	<head>
	    ...
	    <title>Ferretería DAO| Has olvidado tu contraseña</title>
