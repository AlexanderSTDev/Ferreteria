	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>Lista de Favoritos</li>
			</ul>
...
<div class="body-content outer-top-bd">
	...
	<div class="table-responsive">
		<table class="table">
			<thead>
				<tr>
					<th colspan="4">Mi lista de Favoritos</th>
				</tr>
			</thead>
			<tbody>
<?php
...
?>
				...
				<?php } } else{ ?>
				<tr>
					<td style="font-size: 18px; font-weight:bold ">Tu lista de favoritos, Esta vacía</td>
