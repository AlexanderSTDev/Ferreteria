...
if (isset($_POST['shipupdate'])) {
	...
	if ($query) {
		echo "<script>alert('La dirección de envio ha sido actualizada');</script>";
	}
}
		...
		<div class="container">
			<div class="breadcrumb-inner">
				<ul class="list-inline list-unstyled">
					<li><a href="#">Home</a></li>
					<li class='active'>Carro de la compra</li>
				</ul>
													...
													<tr>
														...
														<td class="cart-image">
															<a class="entry-thumbnail" href="detail.html">
																<img src="admin/productimages/<?php echo $row['id']; ?>/<?php echo $row['productImage1']; ?>" alt="" width="130" height="150">
															</a>
														</td>
									...
									<td>
										<div class="form-group">
											...
											?>
												...
												<div class="form-group">
													<label class="info-title" for="Billing State ">Provincia de Facturación <span>*</span></label>
												...
												<button type="submit" name="update" class="btn-upper btn btn-primary checkout-page-button">Grabar</button>
									...
									<td>
										<div class="form-group">
											...
											?>
												...
												<div class="form-group">
													<label class="info-title" for="Billing State ">Provincia de Envío <span>*</span></label>
												...
												<button type="submit" name="shipupdate" class="btn-upper btn btn-primary checkout-page-button">Grabar</button>
											<?php } ?>
								...
								<tr>
									<td>
										<div class="cart-checkout-btn pull-right">
											<button type="submit" name="ordersubmit" class="btn btn-primary">PROCESAR EL PAGO</button>
