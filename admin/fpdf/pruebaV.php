...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(110);  // mover a la derecha
      $this->SetFont('Arial', 'B', 10);
      $this->Cell(85, 10, utf8_decode("Correo : ferrdao@gmail.com"), 0, 0, '', 0);
      $this->Ln(5);
      ...
      $this->Cell(25, 10, utf8_decode('SUBCATEGORIA'), 1, 0, 'C', 1);
      $this->Cell(70, 10, utf8_decode('NOMBRE DE EMPRESA'), 1, 0, 'C', 1);
      $this->Cell(70, 10, utf8_decode('FECHA DE CREACION'), 1, 0, 'C', 1);
      $this->Cell(25, 10, utf8_decode('ACCION'), 1, 1, 'C', 1);
   }
