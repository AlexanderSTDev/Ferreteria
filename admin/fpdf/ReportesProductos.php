...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(100, 10, utf8_decode("PRODUCTOS"), 0, 1, 'C', 0);
      $this->Ln(7);
      ...
      $this->Cell(50, 10, utf8_decode('NOMBRE DE LA EMPRESA'), 1, 0, 'C', 1);
...
$consulta_reporte_productos = $conexion->query("SELECT productName, category.categoryName, subcategory.subcategory, productCompany, postingDate  FROM products INNER JOIN category ON category.id=products.category INNER JOIN subcategory on subcategory.id=products.subCategory");
...
while ($datos_reporte = $consulta_reporte_productos->fetch_object()) {      
   ...
   $pdf->Cell(50, 10, utf8_decode($datos_reporte->productCompany), 1, 0, 'C', 0);
   $pdf->Cell(45, 10, utf8_decode($datos_reporte->postingDate), 1, 1, 'C', 0);
   }


$pdf->Output('Reportes-Productos.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)
