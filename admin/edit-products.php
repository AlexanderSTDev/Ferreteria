...
<head>
	...
	<title>Admin| Actualizar Producto</title>
...
<div class="control-group">
<label class="control-label" for="basicinput">Costo de Envío del Producto</label>
<div class="controls">
<input type="text"    name="productShippingcharge"  placeholder="Introduzca el Costo de Envío del Producto" value="<?php echo htmlentities($row['shippingCharge']);?>" class="span8 tip" required>
</div>
</div>
