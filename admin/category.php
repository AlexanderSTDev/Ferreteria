...
if(isset($_GET['del']))
		  {
                  ...
                  $_SESSION['delmsg']="Categoría elimiada !!";
		  }
...
<div class="controls">
<input type="text" placeholder="Intruce el nombre de la Categoría"  name="category" class="span8 tip" required>
</div>
</div>
...
?>									
										<tr>
											...
											<a href="category.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('¿Estás seguro de que deseas borrar?')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
