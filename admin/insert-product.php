...
$_SESSION['msg']="Producto insertado con éxito !!";
...
<div class="controls">
<input type="text"    name="productShippingcharge"  placeholder="Introduzca el Costo de Envío del Producto" class="span8 tip" required>
</div>
</div>
