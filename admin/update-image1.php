...
$_SESSION['msg']="Imagen del Producto Actualizada Exitosamente !!";
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Actualizar Imagen del Producto 1</h3>
							</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen Actual del Producto 1</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Nueva Imagen del Producto 1</label>
<div class="controls">
